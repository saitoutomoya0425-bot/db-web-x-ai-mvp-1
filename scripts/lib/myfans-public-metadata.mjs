...
export const MYFANS_PARSER_VERSION = "phase6c-v4-modern-browser";
...
export function discoverCreatorCandidatesFromRanking(html, rankingUrl, {
  renderedUnits = [],
  renderedSource = "safari",
  includeGenericAnchors = true,
} = {}) {
  ...
  for (const unit of renderedUnits) {
    ...
    add(unique[0].url, {
      discovery_method: renderedSource === "modern_browser"
        ? "modern_browser_rendered_ranking_unit"
        : "safari_rendered_ranking_unit",
