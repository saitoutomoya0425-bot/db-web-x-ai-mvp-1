...
This phase resolves a validated MyFans Affiliate Collector `0.1.8` preview against migration 029 without changing the database. The resolver performs at most three bounded `SELECT` statements and has no mutation path:
