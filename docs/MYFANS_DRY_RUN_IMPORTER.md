...
This importer validates MyFans Affiliate Collector `0.1.8` JSON and produces a deterministic migration-029-shaped preview. It has no Supabase/Postgres dependency, performs no network request, and cannot apply its output.
